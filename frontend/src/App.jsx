    ...
    return (
      ...
      <Router>
          <Switch>
            ...
            <Route exact path="/prescriptions/updatePickup/:presid" component={ EditPrefTime} />
            ...
            <Route exact path="/Pharm/pharmacies/:pharmid/:medid" render={(props) => < EditInventory {...props} />} />
