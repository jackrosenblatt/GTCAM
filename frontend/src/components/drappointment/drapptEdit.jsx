...
export class DrAppointmentEdit extends React.Component {
    ...
    onAppointmentDeleted() {
        this.drapptRepo.cancelAppointmentById(+this.props.match.params.apptid)
            .then(resp => {
                this.setState({ redirect: '/DrAppointmentList'})
            });
    }
    ...
    editAppointment() {
        ...
        this.drapptRepo.updateAppointmentById(localStorage.getItem('id'), appt)
        .then(resp => {
